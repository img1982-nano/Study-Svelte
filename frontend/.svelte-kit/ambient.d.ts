...
declare module '$env/static/private' {
	...
	export const MIRIWAY_SYSTEM_LOCALE1_KEYMAP: string;
...
declare module '$env/static/public' {
	...
	export const PUBLIC_OPEN_ROUTER_API: string;
	export const PUBLIC_SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_SECRET: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		MIRIWAY_SYSTEM_LOCALE1_KEYMAP: string;
...
declare module '$env/dynamic/public' {
	export const env: {
		...
		PUBLIC_OPEN_ROUTER_API: string;
		PUBLIC_SUPABASE_AUTH_EXTERNAL_GOOGLE_CLIENT_SECRET: string;
